...
export const getCoreAuthenticationModesMap: (
  ...
  "unique-codes": {
    ...
    name: "Unique codes",
    description:
      "Log in or sign up for Pace using codes sent via email. You need to have set up SMTP to use this method.",
  ...
  google: {
    key: "google",
    name: "Google",
    description: "Allow members to log in or sign up for Pace with their Google accounts.",
  ...
  github: {
    key: "github",
    name: "GitHub",
    description: "Allow members to log in or sign up for Pace with their GitHub accounts.",
    icon: (
      <img
