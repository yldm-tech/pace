...
func (handler *Handler) Register(router gin.IRouter) {
	...
	handler.registerIssueMetaRoutes(router)
	...
	handler.registerIssueIdentifierRoutes(router)
	handler.registerIssueDatesRoutes(router)
	...
	handler.registerCycleIssueListRoutes(router)
	handler.registerIssueCreateRoutes(router)
	handler.registerModuleBasicsRoutes(router)
	handler.registerModuleListRoutes(router)
	handler.registerModuleCreateRoutes(router)
	handler.registerModuleCRUDRoutes(router)
	handler.registerModuleIssueRoutes(router)
	handler.registerArchivedModuleRoutes(router)
	handler.registerArchivedModuleDetailRoutes(router)
	handler.registerArchivedCycleRoutes(router)
	handler.registerArchivedCycleDetailRoutes(router)
