...
func TestProjectRouteInventory(t *testing.T) {
	...
	expected := map[string]bool{
		...
		"GET /api/workspaces/:slug/states/":                                                       true,
		"GET /api/workspaces/:slug/cycles/":                                                       true,
		"GET /api/workspaces/:slug/modules/":                                                      true,
		"GET /api/workspaces/:slug/projects/details/":                                             true,
		"POST /api/workspaces/:slug/projects/:id/archive/":                                        true,
		"DELETE /api/workspaces/:slug/projects/:id/archive/":                                      true,
		"GET /api/workspaces/:slug/project-identifiers/":                                          true,
		"DELETE /api/workspaces/:slug/project-identifiers/":                                       true,
		"GET /api/workspaces/:slug/projects/:id/project-deploy-boards/":                           true,
		"POST /api/workspaces/:slug/projects/:id/project-deploy-boards/":                          true,
		"GET /api/workspaces/:slug/projects/:id/project-deploy-boards/:board/":                    true,
		"PATCH /api/workspaces/:slug/projects/:id/project-deploy-boards/:board/":                  true,
		"DELETE /api/workspaces/:slug/projects/:id/project-deploy-boards/:board/":                 true,
		"GET /api/workspaces/:slug/projects/:id/invitations/":                                     true,
		"POST /api/workspaces/:slug/projects/:id/invitations/":                                    true,
		"GET /api/workspaces/:slug/projects/:id/invitations/:invite/":                             true,
		"DELETE /api/workspaces/:slug/projects/:id/invitations/:invite/":                          true,
		"GET /api/workspaces/:slug/projects/:id/join/:invite/":                                    true,
		"POST /api/workspaces/:slug/projects/:id/join/:invite/":                                   true,
		"GET /api/users/me/workspaces/:slug/projects/invitations/":                                true,
		"POST /api/users/me/workspaces/:slug/projects/invitations/":                               true,
		"GET /api/workspaces/:slug/projects/:id/project-estimates/":                               true,
		"GET /api/workspaces/:slug/projects/:id/estimates/":                                       true,
		"POST /api/workspaces/:slug/projects/:id/estimates/":                                      true,
		"GET /api/workspaces/:slug/projects/:id/estimates/:estimate/":                             true,
		"PATCH /api/workspaces/:slug/projects/:id/estimates/:estimate/":                           true,
		"DELETE /api/workspaces/:slug/projects/:id/estimates/:estimate/":                          true,
		"POST /api/workspaces/:slug/projects/:id/estimates/:estimate/estimate-points/":            true,
		"PATCH /api/workspaces/:slug/projects/:id/estimates/:estimate/estimate-points/:point/":    true,
		"DELETE /api/workspaces/:slug/projects/:id/estimates/:estimate/estimate-points/:point/":   true,
		...
		"GET /api/workspaces/:slug/draft-issues/":        true,
		"POST /api/workspaces/:slug/draft-issues/":       true,
		"GET /api/workspaces/:slug/draft-issues/:id/":    true,
		"PATCH /api/workspaces/:slug/draft-issues/:id/":  true,
		"DELETE /api/workspaces/:slug/draft-issues/:id/": true,
		"POST /api/workspaces/:slug/draft-to-issue/:id/": true,

		"GET /api/workspaces/:slug/user-profile/:user/":          true,
		"GET /api/workspaces/:slug/user-stats/:user/":            true,
		"GET /api/workspaces/:slug/user-activity/:user/":         true,
		"POST /api/workspaces/:slug/user-activity/:user/export/": true,
		"GET /api/workspaces/:slug/recent-visits/":               true,
		"GET /api/workspaces/:slug/project-members/":             true,
		...
		"GET /api/workspaces/:slug/projects/:id/advance-analytics/":        true,
		"GET /api/workspaces/:slug/projects/:id/advance-analytics-stats/":  true,
		"GET /api/workspaces/:slug/projects/:id/advance-analytics-charts/": true,
		...
		"POST /api/workspaces/:slug/file-assets/":                   true,
		"GET /api/workspaces/file-assets/:workspace/:key/":          true,
		"DELETE /api/workspaces/file-assets/:workspace/:key/":       true,
		"POST /api/workspaces/file-assets/:workspace/:key/restore/": true,
		"POST /api/users/file-assets/":                              true,
		"GET /api/users/file-assets/:key/":                          true,
		"DELETE /api/users/file-assets/:key/":                       true,

		"GET /api/workspaces/:slug/projects/:id/issues/:issue/issue-attachments/":           true,
		"POST /api/workspaces/:slug/projects/:id/issues/:issue/issue-attachments/":          true,
		"DELETE /api/workspaces/:slug/projects/:id/issues/:issue/issue-attachments/:asset/": true,

		"GET /api/workspaces/:slug/projects/:id/archived-cycles/:cycle/":   true,
		"GET /api/workspaces/:slug/projects/:id/archived-modules/:module/": true,

		"GET /api/workspaces/:slug/projects/:id/cycles/:cycle/cycle-issues/:issue/":    true,
		"PUT /api/workspaces/:slug/projects/:id/cycles/:cycle/cycle-issues/:issue/":    true,
		"PATCH /api/workspaces/:slug/projects/:id/cycles/:cycle/cycle-issues/:issue/":  true,
		"DELETE /api/workspaces/:slug/projects/:id/cycles/:cycle/cycle-issues/:issue/": true,
		"GET /api/workspaces/:slug/projects/:id/modules/:module/issues/:issue/":        true,
		"PUT /api/workspaces/:slug/projects/:id/modules/:module/issues/:issue/":        true,
		"PATCH /api/workspaces/:slug/projects/:id/modules/:module/issues/:issue/":      true,
		"DELETE /api/workspaces/:slug/projects/:id/modules/:module/issues/:issue/":     true,
	}
