-- Rows for db.0077_draftissue_cycle_user_timezone_project_user_timezone_and_more to act on. Skeleton from apps/api-go/tools/seed_migration_operation.py; edit the values that matter.
