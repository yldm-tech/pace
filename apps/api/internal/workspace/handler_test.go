...
func TestWorkspaceRouteInventory(t *testing.T) {
	...
	expected := map[string]bool{
		...
		"GET /api/workspaces/:slug/stickies/":                           true,
		"POST /api/workspaces/:slug/stickies/":                          true,
		"GET /api/workspaces/:slug/stickies/:sticky/":                   true,
		"PATCH /api/workspaces/:slug/stickies/:sticky/":                 true,
		"DELETE /api/workspaces/:slug/stickies/:sticky/":                true,
		"GET /api/workspaces/:slug/user-favorites/":                     true,
		"POST /api/workspaces/:slug/user-favorites/":                    true,
		"PATCH /api/workspaces/:slug/user-favorites/:favorite/":         true,
		"DELETE /api/workspaces/:slug/user-favorites/:favorite/":        true,
		"GET /api/workspaces/:slug/user-favorites/:favorite/group/":     true,
		"GET /api/workspaces/:slug/user-favorite-projects/":             true,
		"POST /api/workspaces/:slug/user-favorite-projects/":            true,
		"DELETE /api/workspaces/:slug/user-favorite-projects/:project/": true,

		"POST /api/assets/v2/workspaces/:slug/projects/:id/":                true,
		"GET /api/assets/v2/workspaces/:slug/projects/:id/:asset/":          true,
		"PATCH /api/assets/v2/workspaces/:slug/projects/:id/:asset/":        true,
		"DELETE /api/assets/v2/workspaces/:slug/projects/:id/:asset/":       true,
		"GET /api/assets/v2/workspaces/:slug/projects/:id/download/:asset/": true,
		"POST /api/assets/v2/workspaces/:slug/projects/:id/:asset/bulk/":    true,
		"POST /api/assets/v2/workspaces/:slug/duplicate-assets/:asset/":     true,
