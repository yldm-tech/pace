-- Rows for db.0068_remove_pagelabel_project_remove_pagelog_project_and_more to act on. Skeleton from apps/api/tools/seed_migration_operation.py; edit the values that matter.
