-- Rows for db.0118_remove_workspaceuserproperties_product_tour_and_more to act on. Skeleton from apps/api/tools/seed_migration_operation.py; edit the values that matter.
