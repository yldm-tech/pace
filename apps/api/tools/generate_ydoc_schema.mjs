 ...
 *     node apps/api/tools/generate_ydoc_schema.mjs > apps/api/internal/ydoc/schema.json
 *     node apps/api/tools/generate_ydoc_schema.mjs --variant=rich > apps/api/internal/ydoc/schema_rich.json
 */
