 ...
 *     node apps/api/tools/generate_parse_rules.mjs > apps/api/internal/ydoc/parse_rules.json
 *     node apps/api/tools/generate_parse_rules.mjs --variant=rich > apps/api/internal/ydoc/parse_rules_rich.json
 */
