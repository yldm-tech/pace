...
export const useGroupIssuesDragNDrop = (
   ...
   * @param issueUpdates
   */
  const updateIssueOnDrop = useCallback(
    async (
      projectId: string,
      issueId: string,
      data: Partial<TIssue>,
    ...
    [workspaceSlug, addCycleToIssue, removeCycleFromIssue, changeModulesInIssue, updateIssue]
  );
  ...
  const handleOnDrop = useCallback(
    ...
    [getIssueById, getIssueIds, updateIssueOnDrop, groupBy, subGroupBy, orderBy]
  );
