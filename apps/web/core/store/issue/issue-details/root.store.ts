...
import { IssueCommentReactionStore } from "./comment-reaction.store";
import type { IIssueCommentReactionStore, IIssueCommentReactionStoreActions } from "./comment-reaction.store";
...
import { IssueSubIssuesStore } from "./sub-issues.store";
import type { IIssueSubIssuesStore, IIssueSubIssuesStoreActions } from "./sub-issues.store";
