...
// types
import type { ICycle, IIssueLabel, IModule, IProject, IState, IUserLite, TIssueServiceType } from "@pace/types";
...
import type { ICalendarStore } from "./issue-calendar-view.store";
import { CalendarStore } from "./issue-calendar-view.store";
import type { IIssueKanBanViewStore } from "./issue-kanban-view.store";
import { IssueKanBanViewStore } from "./issue-kanban-view.store";
