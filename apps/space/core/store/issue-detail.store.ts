...
// pace imports
import { SitesFileService, SitesIssueService } from "@pace/services";
import type { TFileSignedURLResponse, TIssuePublicComment } from "@pace/types";
...
export class IssueDetailStore implements IIssueDetailStore {
  ...
  addIssueComment = async (anchor: string, issueID: string, data: any) => {
    try {
      ...
      console.error("Failed to add issue comment");
      throw error;
    }
  };
