...
import { getFileMetaDataForUpload, generateFileUploadPayload, getAssetIdFromUrl } from "./helper";
import type {
  EFileAssetType,
  TDuplicateAssetData,
...
export class FileService extends APIService {
  // protected so that SitesFileService, which cancels differently, can still reach them.
  protected cancelSource: any;
  protected fileUploadService: FileUploadService;

  // The base url stays optional so that SitesFileService can still point this at the public site host.
